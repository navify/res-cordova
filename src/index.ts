import { pathWritable } from '@navify/utils-fs';
...
namespace CordovaRes {
  ...
  export interface Options {
     ...
     *
     * `res-cordova` operates in the root of a standard Cordova project setup.
